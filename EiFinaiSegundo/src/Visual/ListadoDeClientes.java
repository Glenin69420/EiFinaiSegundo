...
public class ListadoDeClientes extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ListadoDeClientes dialog = new ListadoDeClientes();
	...
	public ListadoDeClientes() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ListadoDeClientes.class.getResource("/Imagenes/usuario-especialista.png")));
